...
subroutine coor_ini()             ! define a subroutine ,build the coordinates
	...
	do 1001 i = 1,6
 		do 1002 j = 1,6					!   initialization process ,set the each interaction be 0;
 			eab(i,j) = 0.0				! 	specific value set after that;
 1002 	continue
 1001 continue

 	eab(1,2) = 1.0			
	eab(1,4) =  1.5				! methanol ->4
 	eab(1,5) = 1.0	
	eab(2,4) = -1.0
 	eab(2,5) = 0.0
...
!	write(*,*)'to be continue 1011'
	ncountNP = nct
	print*,'numOfNP=',ncountNP,nOfNeiP
! 	do 1014 i = 1,nct
...
! 1014 continue
	...
	do 1015 i = 1, nLattp
		...
		nearP(i) = nearP(i) + 1										! count from (0,0,0) as the 1st atom;

1016 continue
1015 continue
!	print*,'to be continue 1016 ' 
! 	do 1017 i = 1,100
! 		do 1018 j = 1,nOfNeiP

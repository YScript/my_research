...
{	
	int zc = 11; // the cutting off height;
...
/*	caculate the mean square radius of gyration of A monomer belong BCP*/
	...
	{	
		...
		id_of_chain =i+ number_ghp;
			...
			xj =atoms[nchain[id_of_chain][0]].x;
			yj =atoms[nchain[id_of_chain][0]].y;
			zj =atoms[nchain[id_of_chain][0]].z;

				
			xk =atoms[nchain[id_of_chain][len_fa-1]].x;
			yk =atoms[nchain[id_of_chain][len_fa-1]].y;
			zk =atoms[nchain[id_of_chain][len_fa-1]].z;

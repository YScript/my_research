    ...
    program main
	Dimension natom(216000,3),icha(216000),nchain(900,12),nna(216000,26),nn(216000)
	COMMON /CSEED/ ISEED
...
write(*,*)'after 7'
  do 9 kkk=1,ntotc
   ...
   521 continue
  9 continue
write(2,*) 'naa=',float(naa)/ntotA,'nab=',float(nab)/ntotA,'nas=',float(nas)/ntotA,'naw=',float(naw)/ntotA
  end
